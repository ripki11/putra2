...
/*============== WATERMARK ==============*/
global.gcname = '𝑺𝒊𝒎𝒑𝒍𝒆 𝑩𝒐𝒕 𝑾𝒉𝒂𝒕𝒔𝑨𝒑𝒑 𝑩𝒚 '//nama group kalian
global.wm = 'By BOT-OL' //Main Watermark
global.wm2 = 'ripki'
global.wm3 = 'BOT-OL | By RIPKI'
global.botdate = `⻝ 𝗗𝗮𝘁𝗲: ${week} ${date}\n⻝ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `⻝ 𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `BOT-OL | ʙʏ ${global.nameown}`
global.author = 'itoy' 
global.packname = 'ITOY'
global.danied = '✘ 𝗘𝗥𝗢𝗥 𝟰𝟬𝟰'
global.ultahowner = 'Januari 09 2024'
